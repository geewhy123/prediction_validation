...
int main(){
  ...
  //window
  //  ifstream file("../insight_testsuite/tests/test_0/input/window.txt");                                                                                                  
  ifstream file("../insight_testsuite/tests/test_1b/input/window.txt");                                                                                                      
  string line;
  int window;                                                                                                                                                                 
  while (std::getline(file, line)) {                                                                                                                                          
    stringstream ss(line); 
  ...
  string filename = "../insight_testsuite/tests/test_1b/input/actual.txt";
  vector <map<string,double> > actual;
  ...
  filename = "../insight_testsuite/tests/test_1b/input/predicted.txt";
  vector <map<string,double> > predicted;
  build(filename,predicted);
  printAll(predicted);
  /*
  ifstream predfile("../insight_testsuite/tests/test_0/input/predicted.txt");
  ...
  */
  ...
  clearFile.open("../insight_testsuite/tests/test_1b/output/comparison2.txt");
  clearFile.close();
  ...
  int k=53;
    ...
    myfile.open("../insight_testsuite/tests/test_1b/output/comparison2.txt",std::ios_base::app);
    myfile << k+1 << "|" << k+window << "|";
